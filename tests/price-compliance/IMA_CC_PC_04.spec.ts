...
import rawData from '../../data/IMA_CC_PC_04.json';
...
/**
 * Regression — IMA_CC_PC_04 (from CC_PC_Testing_Scenarios "Sheet3").
 * Create the contract, then run a Calculation Simulation and store the
 * Final COGS under results/.
 */
test.describe('Price Compliance — IMA_CC_PC_04 (Regression)', () => {
  test('IMA_CC_PC_04 - create contract then run simulation', async ({ page }) => {
    test.setTimeout(0);
